...
## Design
- Farger: bakgrunn #F3F5F4, tekst #1C2B33, dempet tekst #45545C, linjer #C3D0CF, fjord #2E5E6E, aksent #C24A12 (valgt sted, knapper, bratt i høydeprofil), hovedretning petrol #2E5E6E, mulig lys petrol #6FA3B0 (én farge i tre lysheter, så rosen ikke kan forveksles med vindvurderingens trafikklys), vindvurdering grønn #2E8B57 / gul #D99A1E / mørk rød #A50F15 / grå #7F9396 med tynn mørk kant, og «For mye vind» og «Passer ikke» litt mindre i kartet så vurderingen ikke bare vises med farge, farer-boks #FBE3DA med tekst #6B1A0B, parkering #2F6FB5.
